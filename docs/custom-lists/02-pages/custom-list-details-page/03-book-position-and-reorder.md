...
Defines manual position, reorder behavior, MVP move up/down, and future drag-and-drop.
...
Reusable domain rules live in `01-domain/07-position-and-order-rules.md`.
